...
public class TravelAgency {
    ...
    public Airliner addAirliner(String airlinerName, int noOfAirplanes, String headquarters) {
        Airliner airliner = new Airliner(airlinerName, noOfAirplanes, headquarters);
